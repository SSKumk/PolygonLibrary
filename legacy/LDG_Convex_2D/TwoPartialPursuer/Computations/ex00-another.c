...
/*
    ...
    1 - List of the vertices:  n array -> number_of_points and their coordinates: Q1 and Q2
        Q1Qnt = n1;    
        Q1Vert = {{qDim number}, ... n1-times};    
        Q2Qnt = n2;
        Q2Vert = {{qDim number}, ... n2-times};
    2 - k alternating partitioning: k array -> number_of_parts  [an array of vertex indices of size k x 2]
        QK = k;
        QAltParttitiong = { {ind1, ind2}, ... k-times };
    3 - rotating partitioning: ind1 ind2 step -> index_of_origin1 index_of_origin2 and step of rotating
        QInd1 = ind1;
        QInd2 = ind2;
        QStep = step;
 */
