// Name of the problem
ProblemName = "Oscillator; non-symmetric M";
...
All angles in radians
  Type of the set: 
    1 - List of the vertices: QQnt QVert --> number_of_points and their_coordinates
          QQnt = 4;
...
/* =================================================================================
  ...
  All angles in radians
  Type of the set:
    1 - List of the vertices: MQnt MVert --> number_of_points and their_coordinates
          MQnt = 4;
