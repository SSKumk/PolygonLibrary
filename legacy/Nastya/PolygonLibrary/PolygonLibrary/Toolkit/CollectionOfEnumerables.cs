...
namespace PolygonLibrary.Toolkit
{
    ...
    where T : IEquatable<T>
  {
    ...
    /// </summary>
    /// <param name="val">The lement, to which the enumerator should be put</param>
    /// <returns>An enumerator that can be used to iterate through the collection.</returns>
    ...
    /// </summary>
    /// <param name="en">The enumerator that should be added</param>
