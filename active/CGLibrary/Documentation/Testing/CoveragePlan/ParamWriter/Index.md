...
- [`WritingAndRoundTrip.md`](WritingAndRoundTrip.md)
  Объект: сценарии записи и последующего чтения через `ParamReader`.
  Когда использовать: когда нужно сверить текущий безопасный контракт `ParamWriter`.
