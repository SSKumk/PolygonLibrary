...
- [`RandomGeneration.md`](RandomGeneration.md)
  Объект: сценарии генерации целых, вещественных и типизированных значений, а также массивов.
  Когда использовать: когда нужно сверить текущий контракт `RandomLC`, `GRandomLC`, `GenArray` и `GenArrayInt`.
