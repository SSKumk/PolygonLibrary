...
internal static class GiftWrappingTestData {
  ...
  public static readonly List<Vector> Tetrahedron3DLiftedTo4D =
    [
      new(new double[] { 0, 0, 0, 2 }),
      new(new double[] { 1, 0, 0, 2 }),
      new(new double[] { 0, 1, 0, 2 }),
      new(new double[] { 0, 0, 1, 2 })
    ];

  public static readonly SortedSet<Vector> SquareIn3DWithInnerPointsVertices =
    [
      new(new double[] { 0, 0, 5 }),
      new(new double[] { 1, 0, 5 }),
      new(new double[] { 1, 1, 5 }),
      new(new double[] { 0, 1, 5 })
    ];

  public static readonly List<Vector> SquareIn3DWithInnerPoints =
    [
      new(new double[] { 0, 0, 5 }),
      new(new double[] { 1, 0, 5 }),
      new(new double[] { 1, 1, 5 }),
      new(new double[] { 0, 1, 5 }),
      new(new double[] { 0.5, 0.5, 5 }),
      new(new double[] { 0.25, 0.5, 5 })
    ];
