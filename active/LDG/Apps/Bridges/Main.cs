...
class Program {
  ...
  static void Main(string[] args) {
    ...
    // string problem = "Oscillator3D-mass-epi-hex_prism";
    ...
    // BridgeCreator<Rational, RConvertor> bridgeCreator = new BridgeCreator<Rational, RConvertor>(ldgDir, problem, eps);
