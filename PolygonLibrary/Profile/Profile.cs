...
class Program {
  ...
  //
  //   Console.WriteLine($"{polytop.NearestPoint( new Vector(new ddouble[]{ 2, 0.5, 0.5,2, 0.5 }))}");
  //   Console.WriteLine($"{polytop.NearestPointOpt( new Vector(new ddouble[]{ 2, 0.5, 0.5,2, 0.5 }))}");
  //
  //
