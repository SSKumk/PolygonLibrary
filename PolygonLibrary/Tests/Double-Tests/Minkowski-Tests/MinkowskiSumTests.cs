...
public class MinkowskiSum2D {
  ...
  private Vector        u00,     u10,     u01,     u11, u21, u12, u22;
  private Vector        p0_5__0, p1__0_5, p0_5__1, p0__0_5;
  private ConvexPolytop cp_u11;
  private ConvexPolytop cp_u00u10, cp_u11u21,     cp_u00u01, cp_u11u12, cp_u00u11, cp_u11u22, cp_u11u22_x3, su4;
  private ConvexPolytop sq_orth,   sq_orth_shift, sq_rot;

  [OneTimeSetUp]
  public void SetUp() {
    u00 = new Vector(new double[] { 0, 0 });
    u10 = new Vector(new double[] { 1, 0 });
    u01 = new Vector(new double[] { 0, 1 });
    u11 = new Vector(new double[] { 1, 1 });
    u21 = new Vector(new double[] { 2, 1 });
    u12 = new Vector(new double[] { 1, 2 });
    u22 = new Vector(new double[] { 2, 2 });


    p0_5__0 = new Vector(new double[] { 0.5, 0 });
    p0__0_5 = new Vector(new double[] { 0, 0.5 });
    p1__0_5 = new Vector(new double[] { 1, 0.5 });
    p0_5__1 = new Vector(new double[] { 0.5, 1 });

    cp_u11       = ConvexPolytop.CreateFromPoints(new List<Vector> { u11 });
    cp_u00u01    = ConvexPolytop.CreateFromPoints(new List<Vector> { u00, u01 });
    cp_u00u10    = ConvexPolytop.CreateFromPoints(new List<Vector> { u00, u10 });
    cp_u00u11    = ConvexPolytop.CreateFromPoints(new List<Vector> { u00, u11 });
    cp_u11u12    = ConvexPolytop.CreateFromPoints(new List<Vector> { u11, u12 });
    cp_u11u21    = ConvexPolytop.CreateFromPoints(new List<Vector> { u11, u21 });
    cp_u11u22    = ConvexPolytop.CreateFromPoints(new List<Vector> { u11, u22 });
    cp_u11u22_x3 = ConvexPolytop.CreateFromPoints(new List<Vector> { 3 * u11, 3 * u22 });
    su4          = ConvexPolytop.CreateFromPoints(new List<Vector> { u11, u21 });

#region Squares
    // (0,0) (0,1) (1,0) (1,1)
    sq_orth = ConvexPolytop.CreateFromPoints
      (
       new List<Vector>
         {
           u00
    ...
    // (1,1) (2,1) (1,2) (2,2)
    sq_orth_shift = ConvexPolytop.CreateFromPoints
      (
       new List<Vector>
         {
           u11
    ...
    sq_rot = ConvexPolytop.CreateFromPoints
      (
       new List<Vector>
         {
           p0_5__0
  ...
  [Test]
  public void Point() {
    ConvexPolytop sum = MinkowskiSum.BySandipDas(cp_u11, cp_u11);
    Assert.That(sum, Is.EqualTo(ConvexPolytop.CreateFromPoints(new List<Vector>() { u11 + u11 })));
  }

  // Точка и орт (1,1) + [(0,0), (1,0)]
  [Test]
  public void Point_Orth() {
    ConvexPolytop P   = cp_u11;
    ConvexPolytop Q   = cp_u00u10;
    ConvexPolytop sum = MinkowskiSum.BySandipDas(P, Q);
    Assert.That(sum, Is.EqualTo(MinkowskiSum.ByConvexHull(P, Q)));
  }

  // Точка и отрезок (1,1) + [(0,0), (1,1)]
  [Test]
  public void Point_Seg() {
    ConvexPolytop P   = cp_u11;
    ConvexPolytop Q   = cp_u00u11;
    ConvexPolytop sum = MinkowskiSum.BySandipDas(P, Q);
    Assert.That(sum, Is.EqualTo(MinkowskiSum.ByConvexHull(P, Q)));
  }
  ...
  [Test]
  public void Seg_x2() {
    ConvexPolytop P   = cp_u11u22;
    ConvexPolytop Q   = cp_u11u22_x3;
    ConvexPolytop sum = MinkowskiSum.BySandipDas(P, Q);
    Assert.That(sum, Is.EqualTo(MinkowskiSum.ByConvexHull(P, Q)));
  }

  // Единичный квадрат на ортах
  [Test]
  public void Seg_Seg() {
    ConvexPolytop P   = cp_u00u10;
    ConvexPolytop Q   = cp_u00u01;
    ConvexPolytop sum = MinkowskiSum.BySandipDas(P, Q);
    Assert.That(sum, Is.EqualTo(sq_orth));
  }

  // Единичный квадрат со сдвигом
  [Test]
  public void Seg_Seg_shift() {
    ConvexPolytop P   = cp_u11u21;
    ConvexPolytop Q   = cp_u11u12;
    ConvexPolytop sum = MinkowskiSum.BySandipDas(P, Q);
    Assert.That(sum, Is.EqualTo(MinkowskiSum.ByConvexHull(P, Q)));
  }
  ...
  public void Seg_Square() {
    ConvexPolytop P       = cp_u00u10;
    ConvexPolytop Q       = sq_orth;
    ConvexPolytop sum = MinkowskiSum.BySandipDas(P, Q);
    Assert.That(sum, Is.EqualTo(MinkowskiSum.ByConvexHull(P, Q)));
  }

  // [(1,1), (1,2)] + sq_orth_shift
  [Test]
  public void Seg_Square_shift() {
    ConvexPolytop P   = cp_u11u12;
    ConvexPolytop Q   = sq_orth_shift;
    ConvexPolytop sum = MinkowskiSum.BySandipDas(P, Q);
    Assert.That(sum, Is.EqualTo(MinkowskiSum.ByConvexHull(P, Q)));
  }

  // Шестиугольник --- конфета
  [Test]
...
#region Other tests
  ...
  public void Cube2D_Cube2DinAnotherPlane() {
    var p0 = new Vector(new double[] { 0, 0, 0, 0 });
    var p1 = new Vector(new double[] { 1, 0, 0, 0 });
    var p2 = new Vector(new double[] { 0, 1, 0, 0 });
    var p3 = new Vector(new double[] { 1, 1, 0, 0 });

    var u0 = new Vector(new double[] { 0, 0, 1, 1 });
    var u1 = new Vector(new double[] { 1, 0, 1, 1 });
