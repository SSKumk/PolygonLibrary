...
public class MinkowskiSum2D
{
  ...
  public void SetUp()
  {
    u0 = new Vector(new double[] { 0, 0 });
    u1 = new Vector(new double[] { 1, 0 });
    u2 = new Vector(new double[] { 0, 1 });
    u3 = new Vector(new double[] { 1, 1 });
    u4 = new Vector(new double[] { 1, 2 });


    p0 = new Vector(new double[] { 0.5, 0 });
    p1 = new Vector(new double[] { 1, 0.5 });
  ...
  public void Point_Point()
  {
    ...
    Assert.That(pu3_pu3, Is.EqualTo(new FaceLattice(new Vector(new double[] { 2, 2 }))));
  }
