...
public class VectorsTests {
  ...
  public void IsBetweenTest() {
    ...
    Assert.Multiple(() => {
                      ...
                      Assert.That(v0.IsBetween(v0, v3), Is.False, "Group 101: Test #3");
                      Assert.That(v3.IsBetween(v0, v3), Is.False, "Group 101: Test #4");
                      Assert.That(v0.IsBetween(v0, v4), Is.False, "Group 101: Test #5");
                      Assert.That(v4.IsBetween(v0, v4), Is.False, "Group 101: Test #6");
                      ...
                      Assert.That(v1.IsBetween(v1, v4), Is.False, "Group 102: Test #3");
                      Assert.That(v4.IsBetween(v1, v4), Is.False, "Group 102: Test #4");
                      Assert.That(v1.IsBetween(v1, v5), Is.False, "Group 102: Test #5");
                      Assert.That(v5.IsBetween(v1, v5), Is.False, "Group 102: Test #6");

                      // Group 103: Small cone, the first vector has a negative polar angle, the second has a positive polar angle  
                      Assert.That(v3.IsBetween(v3, v6), Is.False, "Group 103: Test #1");
                      Assert.That(v6.IsBetween(v3, v6), Is.False, "Group 103: Test #2");

                      // Group 104: Small cone, the first vector has the polar angle 0, the second has a positive polar angle  
                      Assert.That(v5.IsBetween(v5, v7), Is.False, "Group 104: Test #1");
                      Assert.That(v7.IsBetween(v5, v7), Is.False, "Group 104: Test #2");
                      Assert.That(v5.IsBetween(v5, v8), Is.False, "Group 104: Test #3");
                      Assert.That(v8.IsBetween(v5, v8), Is.False, "Group 104: Test #4");
                      Assert.That(v5.IsBetween(v5, v9), Is.False, "Group 104: Test #5");
                      Assert.That(v9.IsBetween(v5, v9), Is.False, "Group 104: Test #6");

                      // Group 105: Small cone, both vectors have a positive polar angle   
                      Assert.That(v6.IsBetween(v6, v8), Is.False, "Group 105: Test #1");
                      Assert.That(v8.IsBetween(v6, v8), Is.False, "Group 105: Test #2");
                      Assert.That(v6.IsBetween(v6, v0), Is.False, "Group 105: Test #3");
                      Assert.That(v0.IsBetween(v6, v0), Is.False, "Group 105: Test #4");
                      Assert.That(v7.IsBetween(v7, v9), Is.False, "Group 105: Test #5");
                      Assert.That(v9.IsBetween(v7, v9), Is.False, "Group 105: Test #6");
                      Assert.That(v7.IsBetween(v7, v0), Is.False, "Group 105: Test #7");
                      Assert.That(v0.IsBetween(v7, v0), Is.False, "Group 105: Test #8");

                      // Group 106: Small cone, the first vector has a positive polar angle, the second has a negative polar angle  
                      Assert.That(v7.IsBetween(v7, v2), Is.False, "Group 106: Test #1");
                      Assert.That(v2.IsBetween(v7, v2), Is.False, "Group 106: Test #2");
                      Assert.That(v8.IsBetween(v8, v3), Is.False, "Group 106: Test #3");
                      Assert.That(v3.IsBetween(v8, v3), Is.False, "Group 106: Test #4");
      
                      //-------------------------------------
                      // Flat cones
                      // Group 107: Flat cone, the first vector has the polar angle pi, the second has the polar angle 0  
                      Assert.That(v0.IsBetween(v0, v5), Is.False, "Group 107: Test #1");
                      Assert.That(v5.IsBetween(v0, v5), Is.False, "Group 107: Test #2");

                      // Group 108: Flat cone, the first vector has negative polar angle  
                      Assert.That(v2.IsBetween(v2, v6), Is.False, "Group 108: Test #1");
                      Assert.That(v6.IsBetween(v2, v6), Is.False, "Group 108: Test #2");
                      Assert.That(v3.IsBetween(v3, v7), Is.False, "Group 108: Test #3");
                      Assert.That(v7.IsBetween(v3, v7), Is.False, "Group 108: Test #4");

                      // Group 109: Flat cone, the first vector has the polar angle 0, the second has the polar angle pi  
                      Assert.That(v5.IsBetween(v5, v0), Is.False, "Group 109: Test #1");
                      Assert.That(v0.IsBetween(v5, v0), Is.False, "Group 109: Test #2");

                      // Group 110: Flat cone, the first vector has positive polar angle  
                      Assert.That(v6.IsBetween(v6, v2), Is.False, "Group 110: Test #1");
                      Assert.That(v2.IsBetween(v6, v2), Is.False, "Group 110: Test #2");
                      Assert.That(v7.IsBetween(v7, v3), Is.False, "Group 110: Test #3");
                      Assert.That(v3.IsBetween(v7, v3), Is.False, "Group 110: Test #4");
 
                      //-------------------------------------
                      // Large cones

                      // Group 111: Large cone with angle less than 3*pi/2, the first vector has the polar angle pi  
                      Assert.That(v0.IsBetween(v0, v6), Is.False, "Group 111: Test #1");
                      Assert.That(v6.IsBetween(v0, v6), Is.False, "Group 111: Test #2");

                      // Group 112: Large cone with angle less than 3*pi/2, the first vector has negative polar angle   
                      Assert.That(v2.IsBetween(v2, v7), Is.False, "Group 112: Test #1");
                      Assert.That(v7.IsBetween(v2, v7), Is.False, "Group 112: Test #2");

                      // Group 113: Large cone with angle less than 3*pi/2, the first vector has the polar angle -pi/2   
                      Assert.That(v3.IsBetween(v3, v9), Is.False, "Group 113: Test #1");
                      Assert.That(v9.IsBetween(v3, v9), Is.False, "Group 113: Test #2");

                      // Group 114: Large cone with angle less than 3*pi/2, the first vector has the polar angle 0   
                      Assert.That(v5.IsBetween(v5, v1), Is.False, "Group 114: Test #1");
                      Assert.That(v1.IsBetween(v5, v1), Is.False, "Group 114: Test #2");

                      // Group 115: Large cone with angle equal to 3*pi/2, the first vector has the polar angle 0   
                      Assert.That(v0.IsBetween(v0, v7), Is.False, "Group 115: Test #1");
                      Assert.That(v7.IsBetween(v0, v7), Is.False, "Group 115: Test #2");
      
                      // Group 116: Large cone with angle equal to 3*pi/2, the first vector has negative polar angle   
                      Assert.That(v2.IsBetween(v2, v8), Is.False, "Group 116: Test #1");
                      Assert.That(v8.IsBetween(v2, v8), Is.False, "Group 116: Test #2");

                      // Group 117: Large cone with angle equal to 3*pi/2, the first vector has the polar angle -pi/2   
                      Assert.That(v3.IsBetween(v3, v0), Is.False, "Group 117: Test #1");
                      Assert.That(v0.IsBetween(v3, v0), Is.False, "Group 117: Test #2");
      
                      // Group 118: Large cone with angle equal to 3*pi/2, the first vector has the polar angle 0   
                      Assert.That(v5.IsBetween(v5, v3), Is.False, "Group 118: Test #1");
                      Assert.That(v3.IsBetween(v5, v3), Is.False, "Group 118: Test #2");

                      // Group 119: Large cone with angle equal to 3*pi/2, the first vector has positive polar angle   
                      Assert.That(v6.IsBetween(v6, v4), Is.False, "Group 119: Test #1");
                      Assert.That(v4.IsBetween(v6, v4), Is.False, "Group 119: Test #2");

                      // Group 120: Large cone with angle equal to 3*pi/2, the first vector has the polar angle pi/2   
                      Assert.That(v7.IsBetween(v7, v5), Is.False, "Group 120: Test #1");
                      Assert.That(v5.IsBetween(v7, v5), Is.False, "Group 120: Test #2");
      
                      // Group 121: Large cone with angle greater than 3*pi/2, the first vector has the polar angle 0   
                      Assert.That(v0.IsBetween(v0, v8), Is.False, "Group 121: Test #1");
                      Assert.That(v8.IsBetween(v0, v8), Is.False, "Group 121: Test #2");
                      Assert.That(v0.IsBetween(v0, v9), Is.False, "Group 121: Test #3");
                      Assert.That(v9.IsBetween(v0, v9), Is.False, "Group 121: Test #4");
                      ...
                      Assert.That(v1.IsBetween(v1, v9), Is.False, "Group 122: Test #1");
                      Assert.That(v9.IsBetween(v1, v9), Is.False, "Group 122: Test #2");
      
                      // Group 123: Large cone with angle greater than 3*pi/2, the first vector has negative polar angle, the second one has 0   
                      Assert.That(v1.IsBetween(v1, v0), Is.False, "Group 123: Test #1");
                      Assert.That(v0.IsBetween(v1, v0), Is.False, "Group 123: Test #2");

                      // Group 124: Large cone with angle greater than 3*pi/2, the first vector has the polar angle -pi/2   
                      Assert.That(v3.IsBetween(v3, v2), Is.False, "Group 124: Test #1");
                      Assert.That(v2.IsBetween(v3, v2), Is.False, "Group 124: Test #2");

                      // Group 125: Large cone with angle greater than 3*pi/2, the first vector has the polar angle 0   
                      Assert.That(v5.IsBetween(v5, v4), Is.False, "Group 125: Test #1");
                      Assert.That(v4.IsBetween(v5, v4), Is.False, "Group 125: Test #2");

                      // Group 126: Large cone with angle greater than 3*pi/2, both vectors have positive polar angles   
                      Assert.That(v8.IsBetween(v8, v6), Is.False, "Group 126: Test #1");
                      Assert.That(v6.IsBetween(v8, v6), Is.False, "Group 126: Test #2");
                      ...
                      Assert.That(v5.IsBetween(v0, v2), Is.False, "Group 201: Test #3");
                      Assert.That(v6.IsBetween(v0, v2), Is.False, "Group 201: Test #4");
                      Assert.That(v7.IsBetween(v0, v2), Is.False, "Group 201: Test #5");
                      Assert.That(v8.IsBetween(v0, v2), Is.False, "Group 201: Test #6");
                      Assert.That(v9.IsBetween(v0, v2), Is.False, "Group 201: Test #7");
      
                      Assert.That(v4.IsBetween(v0, v3), Is.False, "Group 201: Test #8");
                      Assert.That(v5.IsBetween(v0, v3), Is.False, "Group 201: Test #9");
                      Assert.That(v6.IsBetween(v0, v3), Is.False, "Group 201: Test #10");
                      Assert.That(v7.IsBetween(v0, v3), Is.False, "Group 201: Test #11");
                      Assert.That(v8.IsBetween(v0, v3), Is.False, "Group 201: Test #12");
                      Assert.That(v9.IsBetween(v0, v3), Is.False, "Group 201: Test #13");
      
                      Assert.That(v5.IsBetween(v0, v4), Is.False, "Group 201: Test #15");
                      Assert.That(v6.IsBetween(v0, v4), Is.False, "Group 201: Test #16");
                      Assert.That(v7.IsBetween(v0, v4), Is.False, "Group 201: Test #17");
                      Assert.That(v8.IsBetween(v0, v4), Is.False, "Group 201: Test #18");
                      Assert.That(v9.IsBetween(v0, v4), Is.False, "Group 201: Test #19");
      
                      // Group 202: Small cone, both vectors have the polar angle less than 0  
                      Assert.That(v4.IsBetween(v1, v3), Is.False, "Group 202: Test #1");
                      Assert.That(v5.IsBetween(v1, v3), Is.False, "Group 202: Test #2");
                      Assert.That(v6.IsBetween(v1, v3), Is.False, "Group 202: Test #3");
                      Assert.That(v7.IsBetween(v1, v3), Is.False, "Group 202: Test #4");
                      Assert.That(v8.IsBetween(v1, v3), Is.False, "Group 202: Test #5");
                      Assert.That(v9.IsBetween(v1, v3), Is.False, "Group 202: Test #6");
                      Assert.That(v0.IsBetween(v1, v3), Is.False, "Group 202: Test #7");
      
                      Assert.That(v5.IsBetween(v1, v4), Is.False, "Group 202: Test #8");
                      Assert.That(v6.IsBetween(v1, v4), Is.False, "Group 202: Test #9");
                      Assert.That(v7.IsBetween(v1, v4), Is.False, "Group 202: Test #10");
                      Assert.That(v8.IsBetween(v1, v4), Is.False, "Group 202: Test #11");
                      Assert.That(v9.IsBetween(v1, v4), Is.False, "Group 202: Test #12");
                      Assert.That(v0.IsBetween(v1, v4), Is.False, "Group 202: Test #13");
      
                      Assert.That(v6.IsBetween(v1, v5), Is.False, "Group 202: Test #14");
                      Assert.That(v7.IsBetween(v1, v5), Is.False, "Group 202: Test #15");
                      Assert.That(v8.IsBetween(v1, v5), Is.False, "Group 202: Test #16");
                      Assert.That(v9.IsBetween(v1, v5), Is.False, "Group 202: Test #17");
                      Assert.That(v0.IsBetween(v1, v5), Is.False, "Group 202: Test #18");
                      ...
                      Assert.That(v9.IsBetween(v3, v6), Is.False, "Group 203: Test #3");
                      Assert.That(v0.IsBetween(v3, v6), Is.False, "Group 203: Test #4");
                      Assert.That(v1.IsBetween(v3, v6), Is.False, "Group 203: Test #5");
                      Assert.That(v2.IsBetween(v3, v6), Is.False, "Group 203: Test #6");

                      // Group 204: Small cone, the first vector has the polar angle 0, the second has a positive polar angle  
                      Assert.That(v8.IsBetween(v5, v7), Is.False, "Group 204: Test #1");
                      Assert.That(v9.IsBetween(v5, v7), Is.False, "Group 204: Test #2");
                      Assert.That(v0.IsBetween(v5, v7), Is.False, "Group 204: Test #3");
                      Assert.That(v1.IsBetween(v5, v7), Is.False, "Group 204: Test #4");
                      Assert.That(v2.IsBetween(v5, v7), Is.False, "Group 204: Test #5");
                      Assert.That(v3.IsBetween(v5, v7), Is.False, "Group 204: Test #6");
                      Assert.That(v4.IsBetween(v5, v7), Is.False, "Group 204: Test #7");
      
                      Assert.That(v9.IsBetween(v5, v8), Is.False, "Group 204: Test #8");
                      Assert.That(v0.IsBetween(v5, v8), Is.False, "Group 204: Test #9");
                      Assert.That(v1.IsBetween(v5, v8), Is.False, "Group 204: Test #10");
                      Assert.That(v2.IsBetween(v5, v8), Is.False, "Group 204: Test #11");
                      Assert.That(v3.IsBetween(v5, v8), Is.False, "Group 204: Test #12");
                      Assert.That(v4.IsBetween(v5, v8), Is.False, "Group 204: Test #13");

                      Assert.That(v0.IsBetween(v5, v9), Is.False, "Group 204: Test #14");
                      Assert.That(v1.IsBetween(v5, v9), Is.False, "Group 204: Test #15");
                      Assert.That(v2.IsBetween(v5, v9), Is.False, "Group 204: Test #16");
                      Assert.That(v3.IsBetween(v5, v9), Is.False, "Group 204: Test #17");
                      Assert.That(v4.IsBetween(v5, v9), Is.False, "Group 204: Test #18");

                      // Group 205: Small cone, both vectors have a positive polar angle   
                      Assert.That(v9.IsBetween(v6, v8), Is.False, "Group 205: Test #1");
                      Assert.That(v0.IsBetween(v6, v8), Is.False, "Group 205: Test #2");
                      Assert.That(v1.IsBetween(v6, v8), Is.False, "Group 205: Test #3");
                      Assert.That(v2.IsBetween(v6, v8), Is.False, "Group 205: Test #4");
                      Assert.That(v3.IsBetween(v6, v8), Is.False, "Group 205: Test #5");
                      Assert.That(v4.IsBetween(v6, v8), Is.False, "Group 205: Test #6");
                      Assert.That(v5.IsBetween(v6, v8), Is.False, "Group 205: Test #7");
      
                      Assert.That(v1.IsBetween(v6, v0), Is.False, "Group 205: Test #8");
                      Assert.That(v2.IsBetween(v6, v0), Is.False, "Group 205: Test #9");
                      Assert.That(v3.IsBetween(v6, v0), Is.False, "Group 205: Test #10");
                      Assert.That(v4.IsBetween(v6, v0), Is.False, "Group 205: Test #11");
                      Assert.That(v5.IsBetween(v6, v0), Is.False, "Group 205: Test #12");
      
                      Assert.That(v0.IsBetween(v7, v9), Is.False, "Group 205: Test #13");
                      Assert.That(v1.IsBetween(v7, v9), Is.False, "Group 205: Test #14");
                      Assert.That(v2.IsBetween(v7, v9), Is.False, "Group 205: Test #15");
                      Assert.That(v3.IsBetween(v7, v9), Is.False, "Group 205: Test #16");
                      Assert.That(v4.IsBetween(v7, v9), Is.False, "Group 205: Test #17");
                      Assert.That(v5.IsBetween(v7, v9), Is.False, "Group 205: Test #18");
                      Assert.That(v6.IsBetween(v7, v9), Is.False, "Group 205: Test #19");
      
                      Assert.That(v1.IsBetween(v7, v0), Is.False, "Group 205: Test #20");
                      Assert.That(v2.IsBetween(v7, v0), Is.False, "Group 205: Test #21");
                      Assert.That(v3.IsBetween(v7, v0), Is.False, "Group 205: Test #22");
                      Assert.That(v4.IsBetween(v7, v0), Is.False, "Group 205: Test #23");
                      Assert.That(v5.IsBetween(v7, v0), Is.False, "Group 205: Test #24");
                      Assert.That(v6.IsBetween(v7, v0), Is.False, "Group 205: Test #25");

                      // Group 206: Small cone, the first vector has a positive polar angle, the second has a negative polar angle  
                      Assert.That(v3.IsBetween(v7, v2), Is.False, "Group 206: Test #1");
                      Assert.That(v4.IsBetween(v7, v2), Is.False, "Group 206: Test #2");
                      Assert.That(v5.IsBetween(v7, v2), Is.False, "Group 206: Test #3");
                      Assert.That(v6.IsBetween(v7, v2), Is.False, "Group 206: Test #4");

                      Assert.That(v4.IsBetween(v8, v3), Is.False, "Group 206: Test #5");
                      Assert.That(v5.IsBetween(v8, v3), Is.False, "Group 206: Test #6");
                      Assert.That(v6.IsBetween(v8, v3), Is.False, "Group 206: Test #7");
                      Assert.That(v7.IsBetween(v8, v3), Is.False, "Group 206: Test #8");
      
                      //-------------------------------------
                      // Flat cones
                      // Group 207: Flat cone, the first vector has the polar angle pi, the second has the polar angle 0  
                      Assert.That(v6.IsBetween(v0, v5), Is.False, "Group 207: Test #1");
                      Assert.That(v7.IsBetween(v0, v5), Is.False, "Group 207: Test #2");
                      Assert.That(v8.IsBetween(v0, v5), Is.False, "Group 207: Test #3");
                      Assert.That(v9.IsBetween(v0, v5), Is.False, "Group 207: Test #4");

                      // Group 208: Flat cone, the first vector has negative polar angle  
                      Assert.That(v7.IsBetween(v2, v6), Is.False, "Group 208: Test #1");
                      Assert.That(v8.IsBetween(v2, v6), Is.False, "Group 208: Test #2");
                      Assert.That(v9.IsBetween(v2, v6), Is.False, "Group 208: Test #3");
                      Assert.That(v0.IsBetween(v2, v6), Is.False, "Group 208: Test #4");
                      Assert.That(v1.IsBetween(v2, v6), Is.False, "Group 208: Test #5");
      
                      Assert.That(v8.IsBetween(v3, v7), Is.False, "Group 208: Test #6");
                      Assert.That(v9.IsBetween(v3, v7), Is.False, "Group 208: Test #7");
                      Assert.That(v0.IsBetween(v3, v7), Is.False, "Group 208: Test #9");
                      Assert.That(v1.IsBetween(v3, v7), Is.False, "Group 208: Test #10");
                      Assert.That(v2.IsBetween(v3, v7), Is.False, "Group 208: Test #11");
                      ...
                      Assert.That(v3.IsBetween(v5, v0), Is.False, "Group 209: Test #3");
                      Assert.That(v4.IsBetween(v5, v0), Is.False, "Group 209: Test #4");

                      // Group 210: Flat cone, the first vector has positive polar angle  
                      Assert.That(v3.IsBetween(v6, v2), Is.False, "Group 210: Test #1");
                      Assert.That(v4.IsBetween(v6, v2), Is.False, "Group 210: Test #2");
                      Assert.That(v5.IsBetween(v6, v2), Is.False, "Group 210: Test #3");
      
                      Assert.That(v4.IsBetween(v7, v3), Is.False, "Group 210: Test #6");
                      Assert.That(v5.IsBetween(v7, v3), Is.False, "Group 210: Test #7");
                      Assert.That(v6.IsBetween(v7, v3), Is.False, "Group 210: Test #8");
 
                      //-------------------------------------
                      // Large cones

                      // Group 211: Large cone with angle less than 3*pi/2, the first vector has the polar angle pi  
                      Assert.That(v7.IsBetween(v0, v6), Is.False, "Group 211: Test #1");
                      Assert.That(v8.IsBetween(v0, v6), Is.False, "Group 211: Test #2");
                      Assert.That(v9.IsBetween(v0, v6), Is.False, "Group 211: Test #3");

                      // Group 212: Large cone with angle less than 3*pi/2, the first vector has negative polar angle   
                      Assert.That(v8.IsBetween(v2, v7), Is.False, "Group 212: Test #1");
                      Assert.That(v9.IsBetween(v2, v7), Is.False, "Group 212: Test #2");
                      Assert.That(v0.IsBetween(v2, v7), Is.False, "Group 212: Test #3");
                      Assert.That(v1.IsBetween(v2, v7), Is.False, "Group 212: Test #4");

                      // Group 213: Large cone with angle less than 3*pi/2, the first vector has the polar angle -pi/2   
                      Assert.That(v0.IsBetween(v3, v9), Is.False, "Group 213: Test #1");
                      Assert.That(v1.IsBetween(v3, v9), Is.False, "Group 213: Test #2");
                      Assert.That(v2.IsBetween(v3, v9), Is.False, "Group 213: Test #3");

                      // Group 214: Large cone with angle less than 3*pi/2, the first vector has the polar angle 0   
                      Assert.That(v2.IsBetween(v5, v1), Is.False, "Group 214: Test #1");
                      Assert.That(v3.IsBetween(v5, v1), Is.False, "Group 214: Test #2");
                      Assert.That(v4.IsBetween(v5, v1), Is.False, "Group 214: Test #3");
                      ...
                      Assert.That(v9.IsBetween(v2, v8), Is.False, "Group 216: Test #1");
                      Assert.That(v0.IsBetween(v2, v8), Is.False, "Group 216: Test #2");
                      Assert.That(v1.IsBetween(v2, v8), Is.False, "Group 216: Test #3");

                      // Group 217: Large cone with angle equal to 3*pi/2, the first vector has the polar angle -pi/2   
                      Assert.That(v1.IsBetween(v3, v0), Is.False, "Group 217: Test #1");
                      Assert.That(v2.IsBetween(v3, v0), Is.False, "Group 217: Test #2");

                      // Group 218: Large cone with angle equal to 3*pi/2, the first vector has the polar angle 0   
                      Assert.That(v4.IsBetween(v5, v3), Is.False, "Group 218: Test #1");

                      // Group 219: Large cone with angle equal to 3*pi/2, the first vector has positive polar angle   
                      Assert.That(v5.IsBetween(v6, v4), Is.False, "Group 219: Test #1");

                      // Group 220: Large cone with angle equal to 3*pi/2, the first vector has the polar angle pi/2   
                      Assert.That(v6.IsBetween(v7, v5), Is.False, "Group 220: Test #1");
                      ...
                      Assert.That(v0.IsBetween(v1, v9), Is.False, "Group 222: Test #1");
