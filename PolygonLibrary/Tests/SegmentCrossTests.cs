...
public class SegmentCrossTests
{
  ...
  public void CrossingTest()
  {
    ...
    for (int i = 1; i < res.Length; i++)
    {
      ...
      {
        Assert.That(res[i].p, Is.EqualTo(info.p),
          "(direct, direct), test #" + i + ": different result points");
        Assert.That(res[i].p1, Is.EqualTo(info.p1),
    ...
    for (int i = 1; i < res.Length; i++)
    {
      ...
      if (info.crossType == CrossType.NoCross)
      {
        Assert.That(info.p, Is.Null, "(direct, back), test #" + i + ": non-null result point");
        Assert.That(info.p1, Is.Null, "(direct, back), test #" + i + ": non-null additional point");
      }
      else if (info.crossType == CrossType.SinglePoint || info.crossType == CrossType.SinglePoint)
      {
        Assert.IsTrue(res[i].p == info.p,
    ...
    for (int i = 1; i < res.Length; i++)
    {
      ...
      if (info.crossType == CrossType.NoCross)
      {
        Assert.That(info.p, Is.Null, "(back, direct), test #" + i + ": non-null result point");
        Assert.That(info.p1, Is.Null, "(back, direct), test #" + i + ": non-null additional point");
      }
      else if (info.crossType == CrossType.SinglePoint || info.crossType == CrossType.SinglePoint)
      {
        Assert.IsTrue(res[i].p == info.p,
    ...
    for (int i = 1; i < res.Length; i++)
    {
      ...
      if (info.crossType == CrossType.NoCross)
      {
        Assert.That(info.p, Is.Null, "(back, back), test #" + i + ": non-null result point");
        Assert.That(info.p1, Is.Null, "(back, back), test #" + i + ": non-null additional point");
      }
      else if (info.crossType == CrossType.SinglePoint || info.crossType == CrossType.SinglePoint)
      {
        Assert.That(res[i].p, Is.EqualTo(info.p),
