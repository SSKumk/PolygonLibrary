...
public class GrahamScanTests
{
  ...
  public void SquareScanCHTest()
  {
    ...
    expected.Add(new Vector2D(0.0, 0.0));
    expected.Add(new Vector2D(1.0, 0.0));
    expected.Add(new Vector2D(1.0, 1.0));
    expected.Add(new Vector2D(0.0, 1.0));
    ...
    for (int i = 0; i < 10; i++)
    {
      orig.Add(new Vector2D(r.NextPrecise(), r.NextPrecise()));
    }

    // Some points in the initial cutting line
    orig.Add(new Vector2D(0.3, 0.3));
    orig.Add(new Vector2D(0.73, 0.73));

    // Some points in the edges of the convex hull
    orig.Add(new Vector2D(0.0, 0.3));
    orig.Add(new Vector2D(0.0, 0.8));
    orig.Add(new Vector2D(1.0, 0.45));
    orig.Add(new Vector2D(0.55, 0.0));
    orig.Add(new Vector2D(0.65, 1.0));

    // Copies of the vertices
    orig.Add(new Vector2D(0.0, 0.0));
    orig.Add(new Vector2D(0.0, 0.0));
    orig.Add(new Vector2D(1.0, 0.0));
    orig.Add(new Vector2D(1.0, 0.0));
  ...
  public void HexagonScanCHTest()
  {
    ...
    for (int i = 0; i < 10; i++)
    {
      ...
      orig.Add(new Vector2D(x, y));
    }

    // Some points in the initial cutting line
    orig.Add(new Vector2D(0.3, 1));
    orig.Add(new Vector2D(1.73, 1));
    orig.Add(new Vector2D(2.999, 1));

    // Some points in the edges of the convex hull
    orig.Add(new Vector2D(1, 1.3));
    orig.Add(new Vector2D(1, 1.8));
    orig.Add(new Vector2D(1, 0.45));
    orig.Add(new Vector2D(2.55, 0.55));
    orig.Add(new Vector2D(2.65, 1.35));
    orig.Add(new Vector2D(2.05, 1.95));
    orig.Add(new Vector2D(1.65, 2));
    orig.Add(new Vector2D(0.55, 1.55));
    orig.Add(new Vector2D(0.55, 1.55));
    orig.Add(new Vector2D(0.55, 0.45));

    // Copies of the vertices
    orig.Add(new Vector2D(0, 1));
    orig.Add(new Vector2D(0, 1));
    orig.Add(new Vector2D(2, 2));
    orig.Add(new Vector2D(1, 2));
  ...
  public void ClosePointsTest()
  {
    List<Vector2D> S = new List<Vector2D>()
      {
        new Vector2D(0, 0)
      , new Vector2D(1.2258222706569017, -4.85722573273506E-17)
      , new Vector2D(1.2293137478570382, 0.3202558730518721)
      , new Vector2D(1.2293137419301374, 0.3202558833175651)
      , new Vector2D(1.2293563013567925, 7.979727989493313E-17)
      , new Vector2D(1.4142135623730951, -7.632783294297951E-17)
      , new Vector2D(0.7071067811865474, 1.2247448713915892)
      };
  ...
  public void ClosePoints2Test()
  {
    List<Vector2D> S = new List<Vector2D>()
      ...
      , new Vector2D(1, 1.6653345369377348E-16)
      , new Vector2D(0, 0)
      , new Vector2D(5.955924281381142E-05, 1)
      , new Vector2D(1.6653345369377348E-16, 1)
      };
  ...
  public void TriangleTest()
  {
    ...
    SortedSet<Vector2D> additionalPoints = new SortedSet<Vector2D>()
      {
