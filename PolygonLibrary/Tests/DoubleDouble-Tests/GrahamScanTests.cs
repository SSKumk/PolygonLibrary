...
public class GrahamScanTests {
  ...
  public void SquareScanCHTest() {
    ...
    expected.Add(new Point2D(1.0, 0.0));
    expected.Add(new Point2D(1.0, 1.0));
    expected.Add(new Point2D(0.0, 1.0));
    ...
    for (int i = 0; i < 10; i++) {
      orig.Add(new Point2D(r.NextPrecise(), r.NextPrecise()));
    }
    ...
    orig.Add(new Point2D(0.0, 0.3));
    orig.Add(new Point2D(0.0, 0.8));
    orig.Add(new Point2D(1.0, 0.45));
    orig.Add(new Point2D(0.55, 0.0));
    orig.Add(new Point2D(0.65, 1.0));

    // Copies of the vertices
    orig.Add(new Point2D(0.0, 0.0));
    orig.Add(new Point2D(0.0, 0.0));
    orig.Add(new Point2D(1.0, 0.0));
    orig.Add(new Point2D(1.0, 0.0));
  ...
  public void TriangleTest() {
    ...
    HashSet<Point2D> additionalPoints = new HashSet<Point2D>()
      {
