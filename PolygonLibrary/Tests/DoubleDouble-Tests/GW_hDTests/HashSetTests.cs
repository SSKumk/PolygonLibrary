...
public class HashSetTests {
  ...
  public void HashCodeTest1() {
    ...
    Vector e6 = new Vector(new ddouble[] { 1.0000000001, 0, 0, 0, 0 });
  ...
  public void PointHashTest() {
    Vector p1 = new Vector(new ddouble[] { 1 - Tools.Eps / 10, 1, 1 });
    Vector p2 = new Vector(new ddouble[] { 1.0, 1, 1 });

    Vector p11 = new Vector(new ddouble[] { 1 - Tools.Eps, 1, 1 });
    Vector p22 = new Vector(new ddouble[] { 1.0, 1, 1 });
