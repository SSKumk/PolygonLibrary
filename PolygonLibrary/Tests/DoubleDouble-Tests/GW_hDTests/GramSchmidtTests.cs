...
public class GramSchmidtTests {
  ...
  public void TestGramSchmidt_1() {
    Vector[] input    = { new Vector(new ddouble[] { 1, 0 }), new Vector(new ddouble[] { 0, 1 }) };
    Vector[] expected = { new Vector(new ddouble[] { 1, 0 }), new Vector(new ddouble[] { 0, 1 }) };
  ...
  public void TestGramSchmidt_3() {
    Vector[] input = { new Vector(new ddouble[] { 1.5, -2.3, 0.7 }), new Vector(new ddouble[] { 0.8, 1.2, -0.5 }) };

    Vector[] expected =
      {
        new Vector(new ddouble[] { 0.529338504930439, -0.811652374226673, 0.247024635634205 })
      , new Vector(new ddouble[] { 0.844642153633652, 0.476742255517412, -0.243508632514901 })
      };
  ...
  public void TestGramSchmidt_4() {
    Vector[] input =
      ...
      , new Vector(new ddouble[] { 0, 1, 0 })
      , new Vector(new ddouble[] { 0, 0, 1 })
      , new Vector(new ddouble[] { 2, 3, -5 })
      , new Vector(new ddouble[] { 7, 1, 5 })
      };
