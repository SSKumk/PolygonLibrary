...
/// <summary>
/// An interface for reading parameters of the terminal sets of the level set type. 
/// </summary>
public interface ILvlSetType<TNum, TConv>
  ...
  /// <summary>
  ///Reads the parameters required for constructing terminal sets from the corresponding level set function.    
  /// </summary>
