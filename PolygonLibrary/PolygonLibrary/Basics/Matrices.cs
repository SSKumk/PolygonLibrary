...
public class Matrix : IEquatable<Matrix> {
  ...
  #region Operators with matrices
  ...
  #region Operators with matrices and multi-dimensional vectors and points
...
#if DEBUG
    if (m.Cols != v.Dim) {
      throw new ArgumentException("Cannot multiply a matrix (from left) and a vector of improper dimensions");
    }
#endif
...
#if DEBUG
    if (m.Rows != v.Dim) {
      throw new ArgumentException("Cannot multiply a matrix (from right) and a vector of improper dimensions");
    }
#endif
...
#if DEBUG
    if (m.Cols != p.Dim) {
      throw new ArgumentException("Cannot multiply a matrix (from left) and a point of improper dimensions");
    }
#endif
    double[] res = new double[m.Rows];
    int r = m.Rows
  ...
  #region Operators with matrices and two-dimensional vectors and points

  /// <summary>
  /// Multiplication of a matrix by a two-dimensional vector at right. The vector factor and the result
  /// are considered as a column vectors
  /// </summary>
  /// <param name="m">The matrix (first) factor</param>
  /// <param name="v">The vector (second) factor</param>
  /// <returns>The resultant vector</returns>
  public static Vector operator *(Matrix m, Vector2D v) {
#if DEBUG
    if (m.Cols != 2) {
      throw new ArgumentException("Cannot multiply a matrix (from left) and a two-dimensional vector");
    }
#endif
    double[] res = new double[m.Rows];
    int r = m.Rows
  ...
  /// <summary>
  /// Multiplication of a matrix by a two-dimensional vector at left. The vector factor and the result
  /// are considered as row vectors
  /// </summary>
  /// <param name="v">The vector (first) factor</param>
  /// <param name="m">The matrix (second) factor</param>
  /// <returns>The resultant vector (possibly, multi-dimensional)</returns>
  public static Vector operator *(Vector2D v, Matrix m) {
#if DEBUG
    if (m.Rows != 2) {
      throw new ArgumentException("Cannot multiply a matrix (from right) and a two-dimensional vector");
    }
#endif
    double[] res = new double[m.Cols];
    int r = m.Rows
  ...
  /// <summary>
  /// Multiplication of a matrix by a two-dimensional point at right. The point factor is considered
  /// as a column vector. The result is considered as a point
  /// </summary>
  /// <param name="m">The matrix (first) factor</param>
  /// <param name="p">The point (second) factor</param>
  /// <returns>The resultant point (possibly, multi-dimensional)</returns>
  public static Point operator *(Matrix m, Point2D p) {
#if DEBUG
    if (m.Cols != 2) {
