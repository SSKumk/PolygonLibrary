...
#region Operators
    ...
    {
      return Tools.EQ(Math.Abs(v1 * v2), v1.Length * v2.Length);
    }
    ...
    {
      return Tools.EQ(v1 * v2, v1.Length * v2.Length);
    }
    ...
    {
      return Tools.EQ(v1.Length) || Tools.EQ(v2.Length) || 
