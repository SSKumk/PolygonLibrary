...
```
Name              = S; // имя конфигурационного файла траектории
[параметры точки]
DrawFpAim         = B; // рисовать ли точку прицеливания первого игрока
[параметры точки]
DrawSpAim         = B; // рисовать ли точку прицеливания второго игрока
[параметры точки]
```
