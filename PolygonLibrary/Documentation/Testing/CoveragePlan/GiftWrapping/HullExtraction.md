...
- Рандомизированные перестановки и очень большие наборы точек намеренно не тащатся в обязательный минимум.

## Gaps

- Тяжёлые shuffled/randomized stress-сценарии оставлены вне обязательного минимума этого этапа.
