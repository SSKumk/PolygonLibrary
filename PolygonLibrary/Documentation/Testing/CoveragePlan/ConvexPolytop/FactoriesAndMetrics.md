...
| CPT-FAC-005 | x | `Ball_oo` в 2D даёт осепараллельный квадрат. | [`ConvexPolytopFactoriesAndMetricsTests.cs`](../../../../Tests/DoubleGeometry/Polyhedra/ConvexPolytop/ConvexPolytopFactoriesAndMetricsTests.cs#L60) |
| CPT-MET-001 | x | `MinimalDiameter` и `MinDistBtwVs` возвращают минимальное попарное расстояние между вершинами. | [`ConvexPolytopFactoriesAndMetricsTests.cs`](../../../../Tests/DoubleGeometry/Polyhedra/ConvexPolytop/ConvexPolytopFactoriesAndMetricsTests.cs#L74) |
