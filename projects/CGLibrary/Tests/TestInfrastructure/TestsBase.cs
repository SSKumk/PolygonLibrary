...
/// <summary>
/// Provides shared low-level helpers for geometry tests.
/// </summary>
...
public class TestsBase<TNum, TConv> : Geometry<TNum, TConv>
  ...
  /// <summary>
  /// The default deterministic random engine shared by test helpers.
  /// </summary>
...
#region Auxiliary functions
  ...
  /// </summary>
  /// <param name="rnd">The random engine to be used.</param>
  ...
  /// <summary>
  /// Generates a random non-zero shift vector using the current helper range for each coordinate.
  /// </summary>
  /// <param name="dim">The dimension of the vector.</param>
  /// <param name="random">The random to be used. If null, the _random be used.</param>
  /// <returns>A random vector whose coordinates are generated by the current helper range.</returns>
  ...
  /// <summary>
  /// Generates a planar rotation matrix for a given dimension, pair of axes, and angle.
  /// </summary>
